...
public class HeatingSystem {
	...
	public static String WEEK_PROGRAM_ADDRESS = "http://wwwis.win.tue.nl/2id40-ws/7/weekProgram";
	...
	public static ArrayList<Switch> getSwitchesDay (WeekProgram wkpg, String day, String type) 
	throws XmlPullParserException, IOException, CorruptWeekProgramException {
		...
		try {
			...
			while (parser.next() != XmlPullParser.END_DOCUMENT) {
				...
				if (parser.getName().equals("day") && parser.getAttributeValue(null, "name").equals(day)) {
					current_day = parser.getAttributeValue(null, "name");
					switches = parseSwitches(parser);
